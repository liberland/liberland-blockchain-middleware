...
const textsPdf = {
	...
	subtitle:
		"Issued in accordance with the Company Low of the Free Republic of Liberland, henceforth 'Liberland'",
	firstParagraphPart1: "Let it be known to all concerned parties that",
	firstParagraphPart2:
		"has compiled with all the relevant provisions of the Law of Liberland relating to the incorporation of companies.",
